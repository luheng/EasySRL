...
public class QALabels {
    ...
    */
    ...
    /*
    public final static SRLLabel W0_SOMEONE = SRLLabel.make("W0_SOMEONE", true);
    public final static SRLLabel W1_SOMEONE = SRLLabel.make("W1_SOMEONE", true);
    public final static SRLLabel W2_SOMEONE = SRLLabel.make("W2_SOMEONE", true);
    public final static SRLLabel W0_SOMETHING = SRLLabel.make("W0_SOMETHING", true);
    public final static SRLLabel W1_SOMETHING = SRLLabel.make("W1_SOMETHING", true);
    public final static SRLLabel W2_SOMETHING = SRLLabel.make("W2_SOMETHING", true);
    */
    public final static SRLLabel WHERE = SRLLabel.make("WHERE", false);
    public final static SRLLabel WHEN = SRLLabel.make("WHEN", false);
    public final static SRLLabel HOW = SRLLabel.make("HOW", false);
