...
public class ActiveLearningReranker {
    ...
    final MultiResponseSimulator responseSimulator;
    ...
    public static void main(String[] args) {
        ...
        MultiResponseSimulator responseSimulator = new MultiResponseSimulator(goldParses);
    ...
    public ActiveLearningReranker(List<List<InputWord>> sentences, List<Parse> goldParses, BaseCcgParser parser,
                                  MultiResponseSimulator responseSimulator, int nBest) {
    ...
    public void run() {
        ...
        /****************** Generate Queries ******************/
        List<MultiQuery> queryList = new ArrayList<>();
        ...
        for(MultiQuery query : queryList) {
            List<String> words = sentences.get(query.sentenceId)
                .stream()
                .map(inputWord -> inputWord.word)
        ...
        //     }
            ...
            // queryCounter ++;
            // MultiQuery query = queryList.poll();
            // List<Integer> response = responseSimulator.answersForQuery(query);
            // System.out.println(query.toStringWithResponse(response));

            // TODO (julian) this is where I ended.
